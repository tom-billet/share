 ...
 */
final class Version20250419093628 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD registration_date DATETIME NOT NULL, ADD name VARCHAR(50) NOT NULL, ADD surname VARCHAR(50) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP registration_date, DROP name, DROP surname');
    }
}
